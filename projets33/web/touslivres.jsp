  ...
  <div id="container">
        ...
        <form action="getlivre" method="post">
         ...
         <input type="hidden" name="email" value="<%=session.getAttribute("email").toString()%>" />
               ...
               <button type="submit" name="operation" value="Recherchertous">chercher</button>
               </form>
                 <br></br>
            ...
            <c:forEach  items="${requestScope.list}" var="livre">
                <tr>
                    ...
                    <td><c:out value="${livre.edition}"/></td>
                     ...
                     <td> 
                         <form action="getlivre" method="post">
                          <input type="hidden" name="numlivrehi" value="<c:out value="${livre.numlivre}"/>">
                              
                         <center><button type="submit" name="operation"  value="modifier1">Modifier</button></center></td>
                     <td> 
                         <form action="getlivre" method="post">
                          <input type="hidden" name="numlivrehi" value="<c:out value="${livre.numlivre}"/>">
                              <center><button type="submit" name="operation"  value="supprimerlivre">Supprimer</button></center></form>
                     </td>
                </tr>
            </c:forEach>
                      </table>
